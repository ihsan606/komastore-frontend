...
export default {
  ...
  head() {
    return {
      title: "KOMA STORE - Distributor Bahan Bangunan Indonesia Resmi",
      meta: [
        {
          hid: "og:title",
          name: "og:title",
          content: "MI STORE - Distributor Bahan Bangunan Indonesia Resmi",
        },
        {
          hid: "og:site_name",
          name: "og:site_name",
        ...
        },
        {
          hid: "description",
          name: "description",
          content: "Official Toko Online Penjualan Bahan Bangunan",
        },
      ],
    };
  },
